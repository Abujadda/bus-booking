<?php 
	...
	if(isset($_POST['add_user'])){
		...
		$birth = mysqli_real_escape_string($isah, $_POST['birth']);
		...
		$add = mysqli_query($isah, "INSERT INTO `clerk` (fname, lname, email, phone, gender, m_status, birth, address, password, status) VALUES ('$fname', '$lname', '$email', '$phone', '$gender', '$m_status', '$birth', '$address', '$password', '1')");
		if($add){
				...
				<div class="panel panel-default">
				  <div class="panel-body" style="padding: 40px">
				  	...
				  	<form method="POST" action="">
				  		<div class="form-group">
				  			<h4 class="text-left"><b>Add Clerk</b></h4> <hr>
				  		</div>
				  		...
				  		<div class="form-group">
				  			<input type="submit"  name="add_user" id="add_user" class="btn btn-default pull-right" value="Add Clerk">
				  		</div>
				  	</form>
