<?php 
	...
	if(isset($_POST['checkUser'])){
		...
		$ticket = mysqli_query($isah, "SELECT 1 FROM `user_booking` WHERE booking_id='$check' AND status='1'");
				...
				<div class="panel panel-default">
				  <div class="panel-body" style="padding: 40px">
				  	...
				  	<div class="form-group">
				  	 ...
				  	 <img src="../image/bg.jpg" class="img-responsive" style="border-radius: 4px; margin-top: 40px">
