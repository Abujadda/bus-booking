<?php 
	...
	$loadData = mysqli_query($isah, "SELECT * FROM `admin` WHERE email='".$_SESSION['email']."'");
	...
	if(isset($_POST['Update_password'])){
		...
		$Update_password = mysqli_query($isah, "UPDATE `admin` SET password='$password' WHERE email='".$_SESSION['email']."' ");
		if($Update_password){
