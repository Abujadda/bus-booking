<?php 
	...
	if(isset($_POST['cancel'])){
		...
		$cancel = mysqli_query($isah, "UPDATE 'user_booking' SET status=0  WHERE email='".$_SESSION['email']."'");
		if($cancel){
						...
						<div id="myModal" class="modal fade" role="dialog">
						  <div class="modal-dialog">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-footer">
						      	<button type="submit" class="btn btn-danger" name="cancel2" id="cancel">Yes</button>
				  		...
				  		<table class="table table-striped">
						    ...
						    <?php
						    	...
						    	$schedule = mysqli_query($isah, "SELECT * FROM user_booking WHERE email='".$_SESSION['email']."' AND status='1'");
						    ...
						    <tbody>
						      <tr>
						        ...
						        <td><button  type="button" class="btn btn-default btn-sm" name = "cancel" data-toggle="modal" data-target="#myModal">Cancel Ticket</button>
</td>
						      </tr>
						    </tbody>
						    <?php } ?>
