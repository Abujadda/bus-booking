<?php 
	...
	$loadData = mysqli_query($isah, "SELECT * FROM `clerk` WHERE email='".$_SESSION['email']."'");
	...
	if(isset($_POST['Update_profile'])){
		...
		$Update_profile = mysqli_query($isah, "UPDATE `clerk` SET fname='$fname', lname='$lname', email='$email', phone='$phone', birth='$birth', gender='$gender', m_status='$m_status', address='$address' WHERE email='".$_SESSION['email']."'");
		if($Update_profile){
