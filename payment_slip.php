<?php 
	...
	$loadBook = mysqli_query($isah, "SELECT * FROM user_booking WHERE booking_id='".$_SESSION['bid']."'");
	$bookRow = mysqli_fetch_array($loadBook);


	$loadPay = mysqli_query($isah, "SELECT * FROM payment_booking WHERE email='".$_SESSION['email']."'");
				  ...
				  <div class="panel-body" style="padding: 40px">
				  	...
				  	<form method="POST" action="">
						...
						<div class="form-group">
						  ...
						  <div class="form-group">
						  	<a href="print_slip.php" class="btn btn-default btn-sm pull-right" target="_blank">Print Ticket</a>
						  </div>
