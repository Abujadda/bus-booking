<?php 
	...
	$loadData = mysqli_query($isah, "SELECT * FROM `user_profile` WHERE email='".$_SESSION['email']."'");
	...
	if(isset($_POST['Update_profile'])){
		...
		$kin_name = mysqli_real_escape_string($isah, $_POST['kin_name']);
		...
		$Update_profile = mysqli_query($isah, "UPDATE `user_profile` SET fname='$fname', lname='$lname', kin_name='$name', email='$email', phone='$phone', kin_phone='$kin_phone', gender='$gender', m_status='$m_status', address='$address', city='$city' WHERE email='".$_SESSION['email']."'");
		if($Update_profile){
				  		...
				  		<div class="row">
				  			...
				  			<div class="col-md-4">
				  				<div class="form-group">
						  			...
						  			<input type="text" name="kin_name" id="kin_name" class="form-control" placeholder="Next of kin" value="<?php echo $dataUser['kin_name']; ?>" required>
						  		</div>
				  			</div>
				  			...
				  			<div class="col-md-4">
				  				<div class="form-group">
						  			...
						  			<input type="input" name="kin_phone" id="kin_phone" class="form-control" placeholder="090897685670" value="<?php echo $dataUser['kin_phone']; ?>" required>
						  		</div>
				  			</div>
